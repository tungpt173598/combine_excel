...
Route::get('/split', \App\Http\Controllers\ExcelController::class . '@getSplit');
...
Route::post('/add-file', \App\Http\Controllers\ExcelController::class . '@addFile')->name('add-file');
Route::post('/split-file', \App\Http\Controllers\ExcelController::class . '@splitFile')->name('split-file');
